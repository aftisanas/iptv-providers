...
export const metadata: Metadata = {
  ...
  description: `Privacy policy for ${SITE_NAME}. How we collect, use and protect personal data under UK GDPR.`,
    ...
    <div className="pt-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">2. How We Use Subscriber Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">3. Data Protection Standards</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">4. Subscriber Rights</h2>
