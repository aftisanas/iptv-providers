...
const blogContent: Record<string, { content: string[] }> = {
  ...
  "iptv-vs-sky-comparison": {
    content: [
      ...
      "## Cost Comparison\n\nA Sky package with sports and cinema typically costs £60–£100+ per month, often with an 18-month minimum contract. A comparable IPTV subscription with Premium IPTV costs £9.99/month (or as low as £4.17/month on the annual plan) — with no contract and cancel-anytime flexibility. That represents annual savings of £600–£1,200.",
      "## Channel Selection\n\nSky offers curated channel bundles where you pay for channels you may never watch. IPTV provides a much broader selection — 28,000+ channels including all the same Sky channels alongside thousands of additional options from UK and international broadcasters. Nothing is locked behind a higher tier.",
  ...
  "premier-league-streaming-guide": {
    content: [
      ...
      "## How IPTV Changes the Game\n\nWith Premium IPTV, you get access to ALL sports channels — Sky Sports Main Event, Sky Sports Premier League, Sky Sports Football, Sky Sports F1, TNT Sports 1-4, BT Sport, and all relevant backup channels for concurrent matches — all included in one subscription from £9.99/month.",
      ...
      "## Getting Started\n\nPremium IPTV includes full Premier League coverage across all relevant channels, with plans starting from £9.99/month and a 30-day money-back guarantee. Test the sports channels during a Saturday afternoon kickoff — if it performs well during peak sport, it will perform well at any time.",
    ],
  },
};
